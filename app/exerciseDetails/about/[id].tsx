    ...
    <View className="bg-[#18122B] h-full ">
      <ExerciseNavigation index={Number(id)}></ExerciseNavigation>
        ...
        <View className="relative">
          <Ionicons name="create-outline" size={24} color={"white"} className="absolute right-12 top-2"></Ionicons>
          //after clicking this trash-outline
          <Ionicons name="trash-outline" size={24} color={"white"} className="absolute right-3 top-2"></Ionicons>
